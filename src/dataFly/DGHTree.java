...
public class DGHTree 
{
    ...
    public DGHTree createDGHTree(ArrayList<String> values) throws FileNotFoundException{
        ...
        //ArrayList<ArrayList> valueNodeParents = new ArrayList<>();
            ...
            String dghFile = "/C:/Users/USER/Desktop/UTPL/Periodo Abril 2022- Agosto 2022/G.P 4.2/Rene Elizalde/DataFly java/dataFly-master//createdDGHTree.txt";
            File infile = new File(dghFile);
            PrintWriter writer = new PrintWriter(infile); 
            for(int i = 0; i < valueNodes.size(); i++){
                DGHNode test = valueNodes.get(i);
                while(test != null){
                    //System.out.print(test.data + ","); Imprime los valores que contiene el archivo createdDGHTree.txt
    ...
    */
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //DGHTree tree3 = new DGHTree("/C:/Users/USER/Desktop/UTPL/Periodo Abril 2022- Agosto 2022/G.P 4.2/Rene Elizalde/DataFly java/dataFly-master/" + "dghSex");
        //DGHTree tree4 = new DGHTree("/C:/Users/USER/Desktop/UTPL/Periodo Abril 2022- Agosto 2022/G.P 4.2/Rene Elizalde/DataFly java/dataFly-master/" + "dghRace");
