 ...
 */
public class DataFly { //Metodo principal 
    ...
    public static void main(String[] args) throws FileNotFoundException, ClassNotFoundException, SQLException {
        ...
        //Este metodo sirve para consumir una base de datos 
        
        PrivateTable myPrivateTable = dataFly.startGeneralization(dataFly.setup()); //Es el primer paso definimos el objeto myPrivateTable 
        //lo llamamos al objeto datfly y llamamos el primer metodo principal que es el StartGeneralization
        ...
        // Este es el metodo principal, en el que hacemos el llamado al objeto PrivateTable 
    }
    /**
     * Set conn = con
     * @param con 
     ...
     * @throws SQLException 
     */
    public PrivateTable setup() throws FileNotFoundException, SQLException{ //Metodo ejecutador
        /*Setting up*/
        PrivateTable myPrivateTable = new PrivateTable();
        //basically set attribute names
        myPrivateTable.setRowHeadings("Raza,FechaNacimiento,ID,Sexo,Columna 1,Columna 2");//Establecemos los ecabezados de la tabla 
        myPrivateTable.setQuasi("Raza,FechaNacimiento,ID,Sexo");// Identificamos los atributos QI
        myPrivateTable.setTableValues("/C:/Users/USER/Documents/NetBeansProjects/Algoritmo_Datafly/tableInputs.txt");
        //myPrivateTable.setTableValues(conn);//uncomment this when connecting to DB
        myPrivateTable = rectifyTableColumn(myPrivateTable, 0);//rectify ID in this case
        //myPrivateTable.printFormat();
     ...
     * @throws FileNotFoundException 
     */
    public PrivateTable startGeneralization(PrivateTable myPrivateTable) throws FileNotFoundException{ //Empezamos con el metodo 
        //primario definido con startGeneralization de tipo PrivateTable
        System.out.print("Por favor ingresa el valor de k: ");
        ...
        while(seqOccursLessThanKTimes(freqSet, kAnon)){
            ...
            int colToBeGeneralized = getAttributeWithMostDistinctValues(myPrivateTable, freqSet);//Se obtiene el atributo
            ...
            if(columnsGeneralized.containsKey(colToBeGeneralized)){
                ...
                System.out.println("Nivel " + generalizationLevel);
            }
            else{
                columnsGeneralized.put(colToBeGeneralized, 1);
                generalizationLevel = 1;
                 System.out.println("Generacion Nivel: " + generalizationLevel);
            }
            //include DGH Tree
    ...
    public ArrayList<DGHTree> createDGHTrees(PrivateTable table) throws FileNotFoundException{
        ...
        String header = "/C:/Users/USER/Documents/NetBeansProjects/Algoritmo_Datafly/";
        
        //Crea dominio de jerarquia de generalizacion para Raza
        ...
        //Crea dominio de jeraarquia de generalizacion para FechaNacimiento
        ...
        //Crea Dominio de jerarquia de generalizacion para ID
        ...
        //Crea Dominio de jerarquia de generalizacion para Sexo
        DGHTree dghTreeSex = new DGHTree(header + "dghSex");
        dghTreeSex.setWeight(0);
        dghTreeSex.setLabel("Sexo");
    ...
    public int getAttributeWithMostDistinctValues(PrivateTable table, HashMap<ArrayList, Integer> freqList){
        ...
        System.out.println("El atributo:"+attribute);
